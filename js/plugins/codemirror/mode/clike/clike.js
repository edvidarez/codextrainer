...
CodeMirror.defineMode("clike", function(config, parserConfig) {
  ...
  def(["text/x-c++src", "text/x-c++hdr"], {
    name: "clike",
    keywords: words("iniciar_programa finalizar_programa si entonces veces mientras hacer repetir"),
    ...
    typeFirstDefinitions: true,
    atoms: words("inicia_ejecucion termina_ejecucion inicio fin gira_izquierda gira_derecha avanza apagate brinca"),
